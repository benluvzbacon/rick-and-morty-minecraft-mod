...
public class PortalBlock extends BlockWithEntity {
	...
	public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
		return (world, pos, state, blockEntity) -> { if (blockEntity instanceof PortalBlockEntity pbe) PortalBlockEntity.tick(world, pos, state, pbe); };
	}
	...
	public static PortalBlockEntity place(net.minecraft.world.WorldAccess world, BlockPos pos, PortalColor color) {
